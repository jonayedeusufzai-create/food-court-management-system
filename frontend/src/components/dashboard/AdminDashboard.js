...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    // In a real implementation, you would verify the token and user role
    ...
    <div className="admin-sidebar">
      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          <li>
            <button 
              className={activeSection === 'stalls' ? 'active' : ''}
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case 'stalls':
        // This will be handled by routing to ManageStalls component
        return null;
      case 'menu':
        // This will be handled by routing to ManageMenu component
        return null;
      case 'orders':
        return (
